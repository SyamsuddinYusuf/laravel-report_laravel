...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        JADWAL KAPAL BERANGKAT PER BULAN 
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <thead>
                ...
                @foreach($data as $p2)
                <tr>
                <td align=center>{{ $p2->NAMA_PELAYARAN}}</td>
                <td align=center>{{ $p2->NAMA_KAPAL}}</td>
                <td align=center>{{ $p2->FOI}}</td>
                <td align=center>{{ $p2->KOTA_ASAL}}</td>
                <td align=center>{{ $p2->KOTA_TUJUAN}}</td>
                <td align=center>{{ $p2->ETD}}</td>
                <td align=center>{{ $p2->ETA}}</td>
                </tr>
                @endforeach
                </tbody>
                <!-- <tfoot>
