          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($data as $p2)
                <tr>
                <td><a href="{{url('/pl/'.$p2->ID_PL)}}"><button type="button" class="btn btn-block btn-info">Detail PL</button></td>
                <td align=center>{{ $p2->NOMER_PACKING_LIST}}</td>
				        <td align=center>{{ $p2->NOMER_BL}}</td>
                <td align=center>{{ $p2->CONTAINER}}</td>
                <td align=center>{{ $p2->NAMA_CUSTOMER}}</td>
                <td align=center>{{ $p2->TUJUAN}}</td>
                <td align=center>{{ $p2->TGL_KEBERANGKATAN}}</td>
                <td align=center>{{ $p2->TGL_TIBA}}</td>
                </tr>
                @endforeach
                </tbody>
                <!-- <tfoot>
