...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        DATA CUSTOMER AKTIF NIAGA LOGISTICS
      </h1>
      <ol class="breadcrumb">
          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <thead>
                ...
                @foreach($data as $p2)
                <tr>
                <td align=center>{{ $p2->NOMER}}</td>
                <td align=center>{{ $p2->TANGGAL}}</td>
                <td align=center>{{ $p2->NAMA_CUSTOMER}}</td>
                <td align=center>{{ $p2->KOTA_TUJUAN}}</td>
                <td align=center>{{ $p2->SUPPLIER}}</td>
                <td align=center>{{ $p2->SJK_GUDANG}}</td>
                <td align=center>{{ $p2->SJM_GUDANG}}</td>
                </tr>
                @endforeach
                </tbody>
                <!-- <tfoot>
